...
export interface DriverStaticData {
  ...
  style: string;
  radioMessage: string;
  radioSource: { race: string; year: number };
}
...
export const DRIVER_STATIC: Record<string, DriverStaticData> = {
  verstappen: {
    ...
    radioSource: { race: "Abu Dhabi Grand Prix", year: 2021 },
  },
  hamilton: {
    ...
    radioSource: { race: "Brazilian Grand Prix", year: 2022 },
  },
  leclerc: {
    ...
    radioSource: { race: "Italian Grand Prix", year: 2019 },
  },
  norris: {
    ...
    radioSource: { race: "Miami Grand Prix", year: 2024 },
  },
  piastri: {
    ...
    radioSource: { race: "Belgian Grand Prix Sprint", year: 2023 },
  },
  russell: {
  ...
  sainz: {
    ...
    radioSource: { race: "Singapore Grand Prix", year: 2023 },
  },
  alonso: {
    ...
    radioSource: { race: "Abu Dhabi Grand Prix", year: 2012 },
  },
  stroll: {
    ...
    radioSource: { race: "Azerbaijan Grand Prix", year: 2022 },
  },
  albon: {
    ...
    radioSource: { race: "Australian Grand Prix", year: 2022 },
  },
  hulkenberg: {
    ...
    radioSource: { race: "Bahrain Grand Prix", year: 2024 },
  },
  magnussen: {
    ...
    radioSource: { race: "Bahrain Grand Prix", year: 2022 },
  },
  gasly: {
    ...
    radioMessage: "Is this real? Is this real life? This is unbelievable!",
    radioSource: { race: "Italian Grand Prix", year: 2020 },
  },
  ocon: {
    ...
    radioSource: { race: "Hungarian Grand Prix", year: 2021 },
  },
  tsunoda: {
    ...
    radioSource: { race: "Bahrain Grand Prix", year: 2021 },
  },
  lawson: {
  ...
  antonelli: {
    ...
    radioSource: { race: "Bahrain Grand Prix", year: 2025 },
  },
  bearman: {
    ...
    radioSource: { race: "Saudi Arabian Grand Prix", year: 2024 },
  },
  bottas: {
  ...
  zhou: {
    ...
    radioSource: { race: "British Grand Prix", year: 2022 },
  },
  colapinto: {
    ...
    radioSource: { race: "Las Vegas Grand Prix", year: 2024 },
  },
  ricciardo: {
    ...
    radioSource: { race: "Monaco Grand Prix", year: 2018 },
  },
  perez: {
    ...
    radioSource: { race: "Saudi Arabian Grand Prix", year: 2021 },
  },
  hadjar: {
    ...
    radioSource: { race: "Bahrain Grand Prix", year: 2026 },
  },
  doohan: {
  ...
  hulkenberg_nico: {
    ...
    radioSource: { race: "Bahrain Grand Prix", year: 2023 },
  },
};
