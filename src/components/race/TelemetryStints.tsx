...
/** 2023+ races have OpenF1 stint data — per-driver pace and tyre degradation table. */
export default function TelemetryStints({ year, round }: { year: string; round: string }) {
